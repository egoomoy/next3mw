...
echo -n "1705637963 vod/output/3/mycat_720.m3u8 mysecret" | openssl md5 -binary | openssl base64 | tr +/ -_ | tr -d =
http://localhost:8070/hls/wrQog9KkXfMgXTQyzG69uQ/1705637963/output/3/mycat_720.m3u8
